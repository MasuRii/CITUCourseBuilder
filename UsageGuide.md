...
- **Full Coverage (All Subjects, Strict):** Only generates schedules if one section for _every_ available subject can fit within your constraints. Can be slow for many subjects.
