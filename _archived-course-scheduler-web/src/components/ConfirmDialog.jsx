  ...
  return (
    ...
    >
      <DialogTitle
        ...
        style={{ color: 'var(--text-color)', display: 'flex', alignItems: 'center', gap: 12 }}
      >
      ...
      <DialogContent>
        <DialogContentText
          ...
          style={{ color: 'var(--text-color)', fontSize: 17, lineHeight: 1.6, marginTop: 8 }}
        >
          {message}
        </DialogContentText>
      </DialogContent>
      <DialogActions>
        <Button onClick={onCancel} style={{ color: 'var(--danger-button-bg)' }}>
          {cancelText}
        </Button>
