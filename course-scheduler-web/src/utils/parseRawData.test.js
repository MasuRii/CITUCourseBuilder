...
describe('parseRawCourseData', () => {
    ...
    describe('Compact Variation Format (ImportDataVariations.md)', () => {
        it('should parse Variation 1 from ImportDataVariations.md', () => {
            const data = "G1 C0 08:00 AM - 12:00 PM WFM FIELD LEC 39/40 In-Person Open G2 C0 01:00 PM - 05:00 PM MWF FIELD LEC 34/40 In-Person Open";
...
Open`;
        ...
        it('should parse mixed closed/open status and different day formats', () => {
            const data = "G3 C0 08:00 AM - 12:00 PM TTHS FIELD LEC 50/50 In-Person Closed G4 C0 01:00 PM - 05:00 PM THST FIELD LEC 41/40 In-Person Closed";
            const result = parseRawCourseData(data);
            expect(result.length).toBe(2);
